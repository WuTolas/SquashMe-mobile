...
public interface TournamentDao extends BaseDao<Tournament> {
    ...
    @Query("SELECT " +
            ...
            "            , CASE WHEN ri1.playerOneScore > ri1.playerTwoScore THEN ri1.playerOneSet ELSE ri1.playerOneSet END AS sets_winning " +
            "            , CASE WHEN ri1.playerOneScore < ri1.playerTwoScore THEN ri1.playerTwoSet ELSE ri1.playerTwoSet END AS sets_losing " +
            "    FROM Result ri1 " +
            ...
            "            , CASE WHEN ri1.playerOneSet < ri1.playerTwoSet THEN 1 ELSE 0 END AS winning " +
            "            , CASE WHEN ri1.playerOneSet > ri1.playerTwoSet THEN 1 ELSE 0 END AS losing " +
            "            , CASE WHEN ri1.playerOneScore < ri1.playerTwoScore THEN ri1.playerTwoSet ELSE ri1.playerTwoSet END AS sets_winning " +
            "            , CASE WHEN ri1.playerOneScore > ri1.playerTwoScore THEN ri1.playerOneSet ELSE ri1.playerOneSet END AS sets_losing " +
            "    FROM Result ri1 " +
            "    INNER JOIN `Match` mi1 ON mi1.id = ri1.match_id " +
            "    WHERE mi1.tournament_id =:tournamentId " +
            "    AND ri1.id IN ( " +
